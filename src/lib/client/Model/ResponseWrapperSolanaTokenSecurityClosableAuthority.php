...
/**
 * ResponseWrapperSolanaTokenSecurityClosableAuthority Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResponseWrapperSolanaTokenSecurityClosableAuthority implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResponseWrapperSolanaTokenSecurity_closable_authority';
     ...
     * Sets address
     *
     * @param string $address Address with upgrade authority
     *
     * @return $this
     */
