...
/**
 * ResponseWrapperSolanaTokenSecurityTransferHook Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResponseWrapperSolanaTokenSecurityTransferHook implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResponseWrapperSolanaTokenSecurity_transfer_hook';
     ...
     * Sets address
     *
     * @param string $address Address of the hook.
     *
     * @return $this
     */
