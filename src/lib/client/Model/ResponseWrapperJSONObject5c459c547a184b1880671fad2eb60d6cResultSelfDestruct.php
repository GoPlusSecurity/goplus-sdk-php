...
/**
 * ResponseWrapperJSONObject5c459c547a184b1880671fad2eb60d6cResultSelfDestruct Class Doc Comment
 *
 * @category Class
 * @description { value: owner_address: owner_type }It describes whether this NFT contract can self destruct. (Notice:When the self-destruct function is triggered, this contract will be destroyed, all functions will be unavailable, and all related assets will be erased.)
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResponseWrapperJSONObject5c459c547a184b1880671fad2eb60d6cResultSelfDestruct implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResponseWrapperJSONObject5c459c547a184b1880671fad2eb60d6c_result_self_destruct';
